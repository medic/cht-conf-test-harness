...
for (const coreVersion of availableCoreVersions) {
  describe(`RulesEngine using core v${coreVersion}`, () => {
    describe(`project-without-source`, () => {
    ...
    describe(`legacy-cht-conf`, () => {
      const harness = new Harness({
        directory: path.join(__dirname, 'collateral', 'legacy-cht-conf'),
        coreVersion,
      });
